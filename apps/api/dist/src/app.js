...
import { PrismaPermissionAssignmentRepository, PrismaPermissionRepository, } from "./infrastructure/prisma/prisma-permission.repository.js";
...
export const createApp = () => {
    ...
    const organizationService = new OrganizationService(prismaClient, organizationRepository, userRepository, roleRepository, permissionRepository, permissionAssignmentRepository, passwordHasher, generateSecurePassword);
    ...
    const permissionService = new PermissionService(prismaClient, permissionRepository, permissionAssignmentRepository, roleRepository);
